...
public class UserController {
	...
	private AuthenticationManager authenticationManager;
	 ...
	 public  String kakaoCallback(String code) { //data를 리턴해줌 
		 ...
		 params.add("client_id", "e13e8b8371361b01e19c42097848238c");
		 ...
		 //Http 요청하기 -Post방식으로- 그리고 response 변수에 응답 받
		ResponseEntity<String> response = rt.exchange(
		 ...
		 //UUID garbagePwd =UUID.randomUUID(); ->중복되지않는 어떤 특정값을 만들어내는 알고리즘 
